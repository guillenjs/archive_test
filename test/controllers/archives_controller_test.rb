...
class ArchivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archive" do
    assert_difference("Archive.count") do
      post archives_url, params: { archive: { archive_data: @archive.archive_data, archive_type_id: @archive.archive_type_id, title: @archive.title } }
    end
  ...
  test "should update archive" do
    patch archive_url(@archive), params: { archive: { archive_data: @archive.archive_data, archive_type_id: @archive.archive_type_id, title: @archive.title } }
